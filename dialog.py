...
class Ui_dialog(object):
    def setupUi(self, Form):
        ...
        Form.resize(1404, 805)
        self.label = QtWidgets.QLabel(Form)
        self.label.setGeometry(QtCore.QRect(10, 10, 60, 16))
        self.label.setObjectName("label")
        self.frame = QtWidgets.QFrame(Form)
        self.frame.setGeometry(QtCore.QRect(40, 750, 1011, 41))
        self.frame.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame.setObjectName("frame")
        self.label_x = QtWidgets.QLabel(self.frame)
        self.label_x.setGeometry(QtCore.QRect(20, 10, 60, 16))
        self.label_x.setObjectName("label_x")
        self.label_y = QtWidgets.QLabel(self.frame)
        self.label_y.setGeometry(QtCore.QRect(190, 10, 60, 16))
        self.label_y.setObjectName("label_y")
        self.label_X = QtWidgets.QLabel(self.frame)
        self.label_X.setGeometry(QtCore.QRect(80, 10, 60, 20))
        self.label_X.setObjectName("label_X")
        self.label_Y = QtWidgets.QLabel(self.frame)
        self.label_Y.setGeometry(QtCore.QRect(280, 10, 60, 16))
        self.label_Y.setObjectName("label_Y")
        self.btn_send = QtWidgets.QPushButton(self.frame)
        self.btn_send.setGeometry(QtCore.QRect(620, 0, 141, 41))
        self.btn_send.setObjectName("btn_send")
        self.label_D = QtWidgets.QLabel(self.frame)
        self.label_D.setGeometry(QtCore.QRect(410, 10, 60, 16))
        self.label_D.setObjectName("label_D")
        self.label_d = QtWidgets.QLabel(self.frame)
        self.label_d.setGeometry(QtCore.QRect(480, 10, 60, 16))
        self.label_d.setObjectName("label_d")
        self.btn_save = QtWidgets.QPushButton(self.frame)
        self.btn_save.setGeometry(QtCore.QRect(810, 0, 151, 41))
